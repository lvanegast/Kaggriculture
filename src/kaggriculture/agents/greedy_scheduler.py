...
class FarmBrainAgent(BaseAgent):
    """Industrial multi-worker competitive agent for Kaggriculture."""

    def __init__(self, name: str = "FarmBrainV3") -> None:
        super().__init__(name=name)
        self.shed_access: Tuple[int, int] = (4, 4)
        self.melon_slots: List[Tuple[int, int]] = [(3, 4), (4, 3), (3, 3), (2, 4)]
